//Mostly someones elses solution, I understand the concept of removing leaf nodes until there is just one or two nodes left. (there can be no more than 2 MHT's)
class Solution {
public:
